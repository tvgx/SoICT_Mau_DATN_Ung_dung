...
% Cấu hình page style cho tất cả trang
\fancypagestyle{plain}{%
\fancyhf{} % clear all header and footer fields
\fancyfoot[R]{\thepage} % Page number ở góc dưới bên phải
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}}

% Apply cho tất cả pages
\pagestyle{plain}
\fancyhf{}
\fancyfoot[R]{\thepage}
...
\setcounter{tocdepth}{2}  % 0=chapter, 1=section, 2=subsection, 3=subsubsection
\setcounter{secnumdepth}{3}  % Number sections up to subsubsection level
...
% PHỤ LỤC - Commented out temporarily
% \appendixpage
% \appendices
% \addappheadtotoc
