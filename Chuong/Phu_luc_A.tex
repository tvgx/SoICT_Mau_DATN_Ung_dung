...
\begin{figure}
\centering
\includegraphics[width=0.75\linewidth]{Hinhve/Phu_luc_A/IoT.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{Hinhve/Phu_luc_A/Bia.PNG}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{Hinhve/Phu_luc_A/GayBia.PNG}
\caption{Qui cách đóng quyển đồ án}
\label{fig:Bia}
\end{figure} 
